    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('penetapan komisi pembimbing', 'Penetapan Komisi Pembimbing'), ('sidang komisi 1', 'Sidang Komisi 1'), ('kolokium', 'Kolokium'), ('proposal', 'Proposal'), ('penelitian dan bimbingan', 'Penelitian dan Bimbingan'), ('evaluasi dan monitoring', 'Evaluasi dan Monitoring'), ('sidang komisi 2', 'Sidang Komisi 2'), ('seminar', 'Seminar'), ('publikasi ilmiah', 'Publikasi Ilmiah'), ('ujian tesis', 'Ujian Tesis')], default='Penetapan Komisi Pembimbing', max_length=50)),
